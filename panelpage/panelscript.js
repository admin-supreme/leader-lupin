...
if(!editor || !body){
console.error("Episode editor elements missing");
return;
}
...
body.innerHTML = `
<input type="number" id="edit_episode_number" placeholder="Episode Number">
<input id="edit_episode_title" placeholder="Episode Title">
<input id="edit_quality" placeholder="Quality">
<input id="edit_language" placeholder="Language">
<input id="edit_server_name" placeholder="Server Name">
<input id="edit_stream_url" placeholder="Stream URL">
<input id="edit_download_url" placeholder="Download URL">
`;

document.getElementById("edit_episode_number").value = ep.episode_number || "";
document.getElementById("edit_episode_title").value = ep.episode_title || "";
document.getElementById("edit_quality").value = ep.quality || "";
document.getElementById("edit_language").value = ep.language || "";
document.getElementById("edit_server_name").value = ep.server_name || "";
document.getElementById("edit_stream_url").value = ep.stream_url || "";
document.getElementById("edit_download_url").value = ep.download_url || "";
